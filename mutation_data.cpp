...
// Set all post-PF_MAX to valid
 ...
 CHANGES_TO (PF_SKIN_LEATHER);

 MUTATION(PF_SKIN_LEATHER);
 PREREQS (PF_THICKSKIN);
 ...
 MUTATION(PF_SKIN_SOFT);

// Mutation-only traits start here

 MUTATION(PF_SKIN_ROUGH);
  CHANGES_TO (PF_SCALES, PF_SKIN_BRISTLE, PF_LIGHTFUR, PF_CHITIN, PF_PLANTSKIN);
  CANCELS (PF_SKIN_SOFT);
 ...
 MUTATION(PF_LIGHT_BONES);
  ...
  MUTATION(PF_SKIN_BRISTLE);
  CHANGES_TO (PF_FEATHERS);

 MUTATION(PF_FEATHERS);
  PREREQS (PF_SKIN_BRISTLE);
 ...
 MUTATION(PF_CLAWS);
  PREREQS (PF_NAILS);
  CANCELS (PF_TALONS, PF_ARM_TENTACLES, PF_PINCERS);

 MUTATION(PF_TALONS);
  PREREQS (PF_NAILS);
  CANCELS (PF_CLAWS, PF_ARM_TENTACLES, PF_PINCERS);
...
// Bad mutations below this point
 ...
 MUTATION(PF_PINCERS);
  PREREQS(PF_CHITIN2);
  CANCELS(PF_NAILS, PF_CLAWS, PF_TALONS, PF_ARM_TENTACLES);

 MUTATION(PF_SHELL);
  PREREQS (PF_CHITIN);
  CANCELS (PF_CHITIN3, PF_FIN_DORSAL);
...
PF_CARNIVORE, PF_SNARL, PF_SHOUT3, PF_CANINE_EARS, PF_TUSKS, PF_CANINE_NOSE,
PF_QUILLS, NULL);
  break;

 case MUTCAT_CATTLE:
  setvector(ret,
PF_SKIN_LEATHER, PF_DISRESISTANT, PF_NIGHTVISION, PF_FUR, PF_PHEROMONE_MAMMAL,
...
PF_WEBBED, PF_UNSTABLE, PF_RADIOACTIVE1, PF_SLIMY, PF_ACID_TRAIL, NULL);
  break;
...
PF_WHISKERS, PF_DEFORMED3, PF_VOMITOUS, PF_HUNGER, PF_TROGLO2, PF_GROWL, PF_CANINE_NOSE, NULL);
  break;
