...
/*    } else if (has_flag(inflammable, x, y) && one_in(96 - cur->density * 10)) {
     cur->age -= cur->density * cur->density * 40;
     smoke += 15;
     if (cur->density == 3)
      ter(x, y) = t_ash;
*/    } else if (has_flag(flammable,  x, y) && one_in(64 - cur->density * 10)) {
     cur->age -= cur->density * cur->density * 40;
     smoke += 15;
     if (cur->density == 3)
      ter(x, y) = t_rubble;
/*    } else if (has_flag(meltable,  x, y) && one_in(64 - cur->density * 10)) {
     cur->age -= cur->density * cur->density * 40;
     if (cur->density == 3)
      ter(x, y) = t_b_metal; */
