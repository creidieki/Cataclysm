...
t_awnfloor, t_support, t_fence_electric, t_ropefence, t_wirefence, t_barbfence,
t_metal_floor,
...
t_paper,
// Tree
t_tree, t_tree_young, t_underbrush, t_stump, t_shrub,
t_root_wall,
t_wax, t_floor_wax,
t_fence_v, t_fence_h, t_post,
...
{"rope fence",       '^', c_yellow,  3,
        mfb(transparent)}, 
{"wire fence",       '^', c_red,     4,
        mfb(transparent)}, 
{"barb wire fence",  '^', c_red,     5,
        mfb(sharp)|mfb(transparent)},
...
{"wax floor",        '.', c_yellow,  2,
	mfb(transparent)|mfb(l_flammable)},
{"picket fence",     '|', c_brown,   4,
	mfb(transparent)|mfb(diggable)|mfb(inflammable)|mfb(noitem)|mfb(thin_obstacle)},
{"picket fence",     '-', c_brown,   4,
	mfb(transparent)|mfb(diggable)|mfb(inflammable)|mfb(noitem)|mfb(thin_obstacle)},
{"fence posts",       '*', c_brown,  3,
        mfb(transparent)|mfb(inflammable)|mfb(thin_obstacle)},
{"railing",          '|', c_yellow,  3,
